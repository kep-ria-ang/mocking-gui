...
status: promoted # Immutable snapshot at the time of the run — subsequent revisions occur only in the promoted version
promoted_to: 'agent-artifacts/specs/ssr-state-sync.md'
date: 2026-07-01
